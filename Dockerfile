...
ADD https://github.com/digitalocean/doctl/releases/download/v${DOCTL_VERSION}/doctl-${DOCTL_VERSION}-linux-amd64.tar.gz /tmp
RUN tar xf /tmp/doctl* \
  && mv /tmp/doctl /bin/doctl \
  && rm -rf /tmp/*
